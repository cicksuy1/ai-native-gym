...
not just witnessed. The mission in `exercises/ship-feature/challenge/MISSION.md` gives you the
constraints; the scorecard grades how the four moved together.

## How to approach it

Don't overthink the feature — pick something real but bounded (a new endpoint with validation, a
config option several modules read, a small feature flag). The grade isn't the code; it's whether
